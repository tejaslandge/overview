...
<body class="bg-slate-100 min-h-screen flex items-center justify-center">
    ...
    <form method="POST" action="/login" class="bg-white w-full max-w-sm p-6 rounded-xl shadow space-y-4">
        @csrf
        ...
        <input type="text" name="username" placeholder="Username" class="w-full rounded border px-3 py-2" required>
